...
export default function Home() {
  ...
  const [initialMediaType, setInitialMediaType] = useState<'image' | 'video'>('image');
              ...
              {user ? (
                <>
                  <button
                    ...
                    className="px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-medium hover:from-purple-500 hover:to-purple-600 transition-all shadow-lg hover:shadow-purple-600/50 flex items-center gap-2"
                  >
        ...
        {!user ? (
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
            ...
            <p className="text-red-400/70 mb-8 max-w-md">
              Create an account to start developing your memories with photos, videos, and audio.
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
            ...
            <p className="text-red-400/70 mb-8 max-w-md">
              Start developing your memories by uploading photos and videos with audio attachments. 
              Add songs or record personal messages to bring your content to life.
            </p>
            <div className="flex gap-3">
              <button
                ...
                className="px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-medium hover:from-purple-500 hover:to-purple-600 transition-all shadow-lg hover:shadow-purple-600/50 flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
